...
<head>
    ...
    if (notificationType === 'deleted') {
        $('#notification').text('Book deleted successfully').fadeIn().delay(2000).fadeOut();
    } else if (notificationType === 'updated') {
        $('#notification').text('Book updated successfully').fadeIn().delay(2000).fadeOut();
    } else if (notificationType === 'added') {
        $('#notification').text('Book added successfully').fadeIn().delay(2000).fadeOut();
    }
        ...
        <div id="editModal" class="modal">
            <div class="modal-content">
                ...
                <form id="editForm" method="POST" action="update_inventory.php">
                    ...
                    <input type="text" name="book_category" id="editBookCategory">
                    <label for="editBookCategory">Category:</label>

                    <input type="text" name="Classification" id="editClassification">
